...
export declare const sanitizeInputProps: (obj: ReturnType<typeof useFormField>, keep?: (keyof ReturnType<typeof useFormField>)[]) => {
    name: FieldId;
    type?: "number" | "reset" | "submit" | "password" | "button" | "search" | "time" | "image" | "text" | "email" | "file" | "hidden" | "url" | "checkbox" | "radio" | (string & {}) | "color" | "date" | "datetime-local" | "month" | "range" | "tel" | "week" | undefined;
    options?: {
        value: string;
        label?: string;
    }[] | undefined;
